...
resource "aws_dynamodb_table" "lotionplus20230411" {
  name         = "lotionplus20230411"
...
locals {
  save_note_function   = "save-note-20230411"
  get_notes_function   = "get-notes-20230411"
  delete_note_function = "delete-note-20230411"
  ...
  "Statement": [
    {
      ...
      "Resource": ["arn:aws:logs:*:*:*", "${aws_dynamodb_table.lotionplus20230411.arn}"],
      "Effect": "Allow"
    }
  ]
}
